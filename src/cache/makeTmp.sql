...
--
	...
	CREATE SERVER csv_files FOREIGN DATA WRAPPER file_fdw;
	  ...
	  DROP FOREIGN TABLE IF EXISTS tmpcsv_autoridade CASCADE; -- danger drop VIEWS
	  CREATE FOREIGN TABLE tmpcsv_autoridade (
		about text,
		preflabel text,
		altlabel text,
		broader text,
		...
		faceta text
	     ...
	     filename '/tmp/tmpcsv/autoridade.csv', 
	     format 'csv', 
	     header 'true'
	  );
	
	  DROP FOREIGN TABLE IF EXISTS tmpcsv_localidade CASCADE; -- danger drop VIEWS
	  CREATE FOREIGN TABLE tmpcsv_localidade (
		about text,
		preflabel text,
		altlabel text,
		broader text,
		...
		faceta text
	     ...
	     filename '/tmp/tmpcsv/localidade.csv', 
	     format 'csv', 
	     header 'true'
	  );
	
	  DROP FOREIGN TABLE IF EXISTS tmpcsv_tipodocumento CASCADE; -- danger drop VIEWS
	  CREATE FOREIGN TABLE tmpcsv_tipodocumento (
		about text,
		preflabel text,
		altlabel text,
		broader text,
		...
		faceta text
	     ...
	     filename '/tmp/tmpcsv/tipodocumento.csv', 
	     format 'csv', 
	     header 'true'
	  );
